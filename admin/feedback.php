...
<?php
		if(mysql_num_rows($res_search)!=0)
		{
			...
			$total_total=0;
			$total_avg=0.00;
			$div_by=mysql_num_rows($res_search);
		    $i=0; 
			...
			// echo "the total perentage of marks is" 
			 echo '<tr><td colspan=16><b>Total</b></td> <td><b>Average</b></td></tr>';
			...
			// echo '<td align=center>&nbsp;</td>';
			 $total_avg = (float)($total_total / $div_by);
			 echo '<td align=center>' .number_format($total_avg,2).'</td>';
			 echo '</tr>';
		 }
		 else
		 {
